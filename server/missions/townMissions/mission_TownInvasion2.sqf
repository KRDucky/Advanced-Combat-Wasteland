...
// ******************************************************************************************
//	@file Name: mission_TownInvasion2.sqf
...
_setupObjects =
{
	...
	_tent1 = createVehicle ["Land_ClothShelter_01_F", _missionPos, [], 3, "None"];
	_tent1 setDir random 360;
	_chair1 = createVehicle ["Land_WoodenCrate_01_F", _missionPos, [], 2, "None"];
	_chair1 setDir random 90;
	_chair2 = createVehicle ["Land_WoodenCrate_01_stack_x5_F", _missionPos, [], 2, "None"];
	...
	_missionHintText = format ["<br/>In or around <t size='1.1' color='%1'>%2</t> enemies have been spotted! There seem to be <t color='%1'>%3</t> of them! Catch them, if you can!", townMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Nice work!<br/><br/><t color='%1'>%2</t><br/>is a clean place again!<br/>All Rats are dead!", townMissionColor, _townName];
