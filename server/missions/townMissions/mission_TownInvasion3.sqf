...
// ******************************************************************************************
//	@file Name: mission_TownInvasion3.sqf
...
_setupVars =
{
	_missionType = "Bandit Stronghold";
...
_setupObjects =
{
	...
	_tent1 = createVehicle ["Land_WoodenCrate_01_stack_x5_F", _missionPos, [], 3, "None"];
	_tent1 setDir random 360;
	_chair1 = createVehicle ["Land_WoodenCrate_01_stack_x3_F", _missionPos, [], 2, "None"];
	_chair1 setDir random 90;
	_chair2 = createVehicle ["Land_WoodenCrate_01_stack_x3_F", _missionPos, [], 2, "None"];
	_chair2 setDir random 180;
	_cFire1	= createVehicle ["Land_WoodenCrate_01_F", _missionPos, [], 2, "None"];
	...
	_missionHintText = format ["<br/>A group of paramilitary bandits claimed <t size='1.1' color='%1'>%2</t> to their stronghold. Kill these <t color='%1'>%3 bastards</t> and clean the area!", townMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Well done!<br/><br/><t color='%1'>%2</t> has been cleared!<br/>Save the crates and get outa there!", townMissionColor, _townName];
