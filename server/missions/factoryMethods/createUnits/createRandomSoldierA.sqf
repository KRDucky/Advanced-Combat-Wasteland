...
// ******************************************************************************************
//	@file Name: createRandomSoldierA.sqf
/*
...
_uniformTypes = ["U_O_T_Soldier_F", "U_B_GhillieSuit", "U_O_GhillieSuit", "U_I_GhillieSuit", "U_I_OfficerUniform", "U_IG_leader", "	U_BG_leader", "U_I_G_Story_Protagonist_F"];
