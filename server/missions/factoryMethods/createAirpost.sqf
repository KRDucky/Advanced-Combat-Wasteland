...
/*
	Original Script
	createAirpost.sqf Author: Joris-Jan van 't Land
	Edited by armatec, JoSchaap, AgentRev, GriffinZS
...
_objList = call compile preprocessFileLineNumbers format ["server\missions\airposts\%1.sqf", _fileName];
_objs = [];
