...
// ******************************************************************************************
//	@file Name: mission_TroopsRelocation.sqf
...
private ["_convoyVeh","_veh1","_veh2","_veh3","_veh4","_veh5","_createVehicle","_pos","_rad","_vehiclePosArray","_vPos1","_vPos2","_vPos3","_vehiclePos1","_vehiclePos2","_vehiclePos3","_vehiclePos4","_vehicles","_leader","_speedMode","_waypoint","_vehicleName","_numWaypoints","_cash","_drugpilerandomizer","_drugpile","_box1","_box2"];

_setupVars =
{
	_missionType = "Troops' Relocation";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_convoyVeh = ["O_T_APC_Wheeled_02_rcws_ghex_F","O_T_Truck_03_device_ghex_F","O_T_Truck_03_ammo_ghex_F","O_T_MRAP_02_hmg_ghex_F","O_T_APC_Tracked_02_cannon_ghex_F"];
	...
	_createVehicle = {
		...
		_soldier = [_aiGroup, _position] call createRandomSoldierA; 
	...
	_missionHintText = format ["Several armed units are one the way to <t color='%1'>relocate their new headquarter</t>, using a <t color='%1'>%2</t> and other armed vehicles. <br/>Intercept this convoy, loot the cargo and get their money!", moneyMissionColor, _vehicleName];
...
_successExec =
{
	...
	_successHintMessage = "Well done! The relocation has been stopped!";
};
