...
_setupVars =
{
	_missionType = "Heavy HEMTT Transport";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_convoyVeh = ["B_MRAP_01_gmg_F","B_Heli_Attack_01_F","B_APC_Tracked_01_rcws_F","B_Truck_01_covered_F","B_APC_Tracked_01_AA_F//"];
	...
	_missionHintText = format ["A HEMTT Transport is on the way, heavily guarded by a Blackfoot and several armed vehicles.<br/>Head there, destroy them all and save their cargo!",  moneyMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Good job! The HEMTT Transport has been stopped!";
};
