...
// ******************************************************************************************
//	@file Name: mission_altisPatrol2.sqf
...
_setupObjects =
{
	...
	_convoyVeh = ["I_MRAP_03_F","B_Heli_Light_01_armed_F","I_MRAP_03_hmg_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F"];
	...
	_missionHintText = format ["Several Striders (armed and unarmed) are on their way, escorted by a AH-9 Pawnee ..",  moneyMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The path of Striders ended deadly. Well done! Save their cargo!";
};
