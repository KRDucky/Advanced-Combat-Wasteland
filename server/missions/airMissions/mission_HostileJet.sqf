...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> has been spotted! Time to die, scumbags!", _vehicleName, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Bam! The mosquito went down! Find the crates and save them!";
};
