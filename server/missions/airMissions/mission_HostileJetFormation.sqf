...
_setupObjects =
{
	...
	_planeChoices =
	[
		["C_Plane_Civil_01_racing_F", "C_Plane_Civil_01_racing_F"],
		["C_Plane_Civil_01_racing_F", "C_Plane_Civil_01_racing_F"],
		["C_Plane_Civil_01_racing_F", "C_Plane_Civil_01_racing_F"]
	];
	...
	_missionHintText = format ["2 <t color='%3'>%1</t> have been spotted. Rumors say, they carry fucking weapon crates - tourists in disguise!", _vehicleName, _vehicleName2, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Well done! The holidays became a nightmare for them!";
};
