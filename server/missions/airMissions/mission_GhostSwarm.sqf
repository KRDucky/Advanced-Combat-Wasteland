...
// ******************************************************************************************
//	@file Name: mission_GhostSwarm.sqf
...
_setupObjects =
{
	...
	_missionHintText = format ["Three <t color='%3'>%1</t> has been spotted. Beautiful to watch - but deadly as well!", _vehicleName, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Good job! The Ghost Swarm came down! Save the crates!";
};
