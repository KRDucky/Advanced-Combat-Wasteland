...
// ******************************************************************************************
//	@file Version: 2.1
//	@file Name: mission_TanoaPatrol.sqf
...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["B_APC_Tracked_01_rcws_F", "O_Heli_Attack_02_black_F", "B_G_Offroad_01_armed_F"],
		["B_APC_Tracked_01_rcws_F", "O_Heli_Attack_02_black_F", "B_G_Offroad_01_armed_F"],
		["B_APC_Tracked_01_rcws_F", "O_Heli_Attack_02_black_F", "B_G_Offroad_01_armed_F"]
	...
	_missionHintText = format ["<br/> A <t color='%2'>%1</t> has been spotted - escorting an <t color='%2'>IFV-6c Panther</t>!<br/>Intercept this little convoy and save its cargo!", _vehicleName, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Good work! The Ghost Hawk convoi has been stopped!";
};
