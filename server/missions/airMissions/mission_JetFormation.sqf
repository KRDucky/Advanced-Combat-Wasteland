...
// ******************************************************************************************
//	@file Name: mission_JetFormation.sqf
...
_setupObjects =
{
	...
	_planeChoices =
	[
		["I_Plane_Fighter_03_CAS_F", "I_Plane_Fighter_03_CAS_F"],
		["I_Plane_Fighter_03_CAS_F", "I_Plane_Fighter_03_CAS_F"],
		["I_Plane_Fighter_03_CAS_F", "I_Plane_Fighter_03_CAS_F"]
	];
	...
	_missionHintText = format ["Why so serious? There are only two <t color='%3'>%1</t> in the sky. Valar morgulis - every man must die. You are the next!", _vehicleName, _vehicleName2, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Valar dohaeris? Fuck this shit and save the crates!";
};
