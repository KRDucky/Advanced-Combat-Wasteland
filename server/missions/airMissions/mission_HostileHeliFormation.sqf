...
_setupVars =
{
	_missionType = "Helicopter Squadron";
...
_setupObjects =
{
	...
	_missionHintText = format ["A squadron of armed helicopters containing a <t color='%3'>%1</t> and two <t color='%3'>%2</t> are patrolling the island. Destroy them and recover their cargo!", _vehicleName, _vehicleName2, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The sky is clear again, the squadron was taken out! Ammo crates have fallen near the wreck.";
};
