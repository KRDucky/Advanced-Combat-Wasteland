...
// ******************************************************************************************
//	@file Name: mission_BlackfootTwins.sqf
...
_setupObjects =
{
	...
	_planeChoices =
	[
		["B_Heli_Attack_01_F", "B_Heli_Attack_01_F"],
		["B_Heli_Attack_01_F", "B_Heli_Attack_01_F"],
		["B_Heli_Attack_01_F", "B_Heli_Attack_01_F"]
	];
	...
	_missionHintText = format ["Attention, ladies and gents! <t color='%3'>Two %1</t> have been spotted.<br/>Do not try to bring them down with improper equipment - otherwise you will die very soon.", _vehicleName, _vehicleName2, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Great job! The two Blackfoots went down. Have you known the real name? Boeing-Sikorsky RAH-66.";
};
