...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["O_G_Offroad_01_armed_F", "O_G_Offroad_01_armed_F", "B_MRAP_01_gmg_F"],
		["O_G_Offroad_01_armed_F", "B_MRAP_01_gmg_F", "O_G_Offroad_01_armed_F"],
		["O_G_Offroad_01_armed_F", "B_MRAP_01_hmg_F", "O_G_Offroad_01_armed_F"]
	...
	_missionHintText = format ["Some <t color='%2'>%1</t> have been spotted - painted black. <br/>Is this the first evidence for IS on Tanoa!?", _vehicleName, transportMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Jesus Christ! No IS - just black painted Offroaders! Save their cargo and pray to .. money.";
};
