...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> is going to be delivered - escorted by <t color='%2'>2 armed Hunters</t>!<br/>Stop the delivery and get the Bobcat!", _vehicleName, transportMissionColor];
