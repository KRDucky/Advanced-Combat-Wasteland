...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "I_Heli_light_03_F"):
			{
...
_successExec =
{
	...
	_successHintMessage = "Well done! The Hellcat has been stopped - finally.";
};
